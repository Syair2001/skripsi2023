...
export default function TambahSentimen() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('/sentimen', formDataToSend, {
  ...
  return (
    <div className='text-black flex items-center justify-center h-screen'>
      ...
      <div className='p-6 shadow-lg w-4/12 rounded-md'>
        <h1 className='text-center font-semibold'>Tambah Sentimen</h1>
